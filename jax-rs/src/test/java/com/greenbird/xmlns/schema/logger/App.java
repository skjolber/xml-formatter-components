...
public class App {
    ...
    public static ResourceConfig createApp1() {
        final ResourceConfig rc = new ResourceConfig()
                .packages(
                		LoggerResource1.class.getPackage().getName(), PrettyPrint.class.getPackage().getName());
    ...
    public static ResourceConfig createApp2() {
        final ResourceConfig rc = new ResourceConfig()
                .packages(
                		LoggerResource2.class.getPackage().getName(), PrettyPrint.class.getPackage().getName());
