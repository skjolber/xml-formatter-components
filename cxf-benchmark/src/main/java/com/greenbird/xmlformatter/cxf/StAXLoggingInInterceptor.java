...
@NoJSR250Annotations
public class StAXLoggingInInterceptor extends org.apache.cxf.interceptor.LoggingInInterceptor {

    private static final Logger defaultLogger = LogUtils.getLogger(StAXLoggingInInterceptor.class);

	private Logger logger = defaultLogger;
	
	public StAXLoggingInInterceptor() {
		super();
	}

	public StAXLoggingInInterceptor(int lim) {
		super(lim);
	}

	public StAXLoggingInInterceptor(PrintWriter w) {
		super(w);
	}

	public StAXLoggingInInterceptor(String id, int lim) {
		super(id, lim);
	}

	public StAXLoggingInInterceptor(String id, PrintWriter w) {
		super(id, w);
	}

	public StAXLoggingInInterceptor(String id, String phase) {
		super(id, phase);
	}

	public StAXLoggingInInterceptor(String phase) {
		super(phase);
	}
